...
int main(int argc, char*agrv[]){
    ...
    const std::string FILENAME = "ladidaTestMuhaha.h5";
    const std::string DATASET_NAME = "/AchMirFaelltKeGuddaNameIn";

    hid_t file_id = H5Fcreate(FILENAME.c_str(),H5F_ACC_TRUNC,H5P_DEFAULT, H5P_DEFAULT);

    hid_t dataspace_id = H5Screate_simple(2,dim,NULL);

    hid_t dataset_id = H5Dcreate2(file_id, DATASET_NAME.c_str(),H5T_NATIVE_INT, dataspace_id, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
...
//    const std::string PATH_DSET_1 = "/dataset_1";
//    const std::string PATH_DSET_2 = "/dataset_2";
//    const int RANK_1 = 2;
//    const int RANK_2 = 2;

//    hsize_t dim1[]{5,5};
//    hsize_t dim2[]{500,500};

//    dataH5 h5Data;
//    h5Data.setFilename(FILENAME);
//    h5Data.setDatasetpath(PATH_DSET_1);
//    h5Data.setDatasetpath2(PATH_DSET_2);
//    h5Data.setRankDSet1(RANK_1);
//    h5Data.setRankDSet2(RANK_2);
//    h5Data.setDatasetDim(dim1);
//    h5Data.setDatasetDim2(dim2);
//    h5Data.createTestData();

//    h5Data.fillWithRndValues();
